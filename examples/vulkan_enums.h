...
enum class MemoryUnmapMaskBit : VkMemoryUnmapFlagsKHR { E_RESERVE_BIT_EXT = VK_MEMORY_UNMAP_RESERVE_BIT_EXT };

enum class ChromaLocation { E_COSITED_EVEN = VK_CHROMA_LOCATION_COSITED_EVEN, E_MIDPOINT = VK_CHROMA_LOCATION_MIDPOINT };

enum class ExportMetalObjectTypeMaskBit : VkExportMetalObjectTypeFlagsEXT {
...
enum class DescriptorPoolCreateMaskBit : VkDescriptorPoolCreateFlags {
...
enum class MicromapType { E_OPACITY_MICROMAP_EXT = VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT };
...
enum class MemoryAllocateMaskBit : VkMemoryAllocateFlags {
...
enum class PeerMemoryFeatureMaskBit : VkPeerMemoryFeatureFlags {
...
enum class DisplayPlaneAlphaMaskBit : VkDisplayPlaneAlphaFlagsKHR {
...
enum class DeviceEventType { E_DISPLAY_HOTPLUG_EXT = VK_DEVICE_EVENT_TYPE_DISPLAY_HOTPLUG_EXT };
...
enum class ExternalFenceFeatureMaskBit : VkExternalFenceFeatureFlags {
  E_EXPORTABLE_BIT = VK_EXTERNAL_FENCE_FEATURE_EXPORTABLE_BIT,
  E_IMPORTABLE_BIT = VK_EXTERNAL_FENCE_FEATURE_IMPORTABLE_BIT
};

enum class ExternalFenceHandleTypeMaskBit : VkExternalFenceHandleTypeFlags {
...
enum class ColorComponentMaskBit : VkColorComponentFlags {
...
enum class ExternalMemoryFeatureMaskBit : VkExternalMemoryFeatureFlags {
...
enum class ExternalMemoryHandleTypeMaskBit : VkExternalMemoryHandleTypeFlags {
...
enum class DeviceDiagnosticsConfigMaskBit : VkDeviceDiagnosticsConfigFlagsNV {
...
enum class DescriptorSetLayoutCreateMaskBit : VkDescriptorSetLayoutCreateFlags {
...
enum class VideoEncodeH265StdMaskBit : VkVideoEncodeH265StdFlagsKHR {
...
enum class PrivateDataSlotCreateMaskBit : VkPrivateDataSlotCreateFlags {};

enum class ShaderModuleCreateMaskBit : VkShaderModuleCreateFlags {};
...
enum class DebugUtilsMessageTypeMaskBit : VkDebugUtilsMessageTypeFlagsEXT {
...
enum class SubgroupFeatureMaskBit : VkSubgroupFeatureFlags {
...
enum class ValidationCheck { E_ALL_EXT = VK_VALIDATION_CHECK_ALL_EXT, E_SHADERS_EXT = VK_VALIDATION_CHECK_SHADERS_EXT };

enum class SparseMemoryBindMaskBit : VkSparseMemoryBindFlags { E_METADATA_BIT = VK_SPARSE_MEMORY_BIND_METADATA_BIT };

enum class RasterizationOrder { E_STRICT_AMD = VK_RASTERIZATION_ORDER_STRICT_AMD, E_RELAXED_AMD = VK_RASTERIZATION_ORDER_RELAXED_AMD };
...
enum class VideoEncodeRateControlModeMaskBit : VkVideoEncodeRateControlModeFlagsKHR {
...
enum class OpticalFlowGridSizeMaskBit : VkOpticalFlowGridSizeFlagsNV {
...
enum class CompositeAlphaMaskBit : VkCompositeAlphaFlagsKHR {
...
enum class DependencyMaskBit : VkDependencyFlags {
...
enum class SemaphoreType { E_BINARY = VK_SEMAPHORE_TYPE_BINARY, E_TIMELINE = VK_SEMAPHORE_TYPE_TIMELINE };
...
enum class SwapchainCreateMaskBit : VkSwapchainCreateFlagsKHR {
  ...
  E_DEFERRED_MEMORY_ALLOCATION_BIT_EXT = VK_SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_EXT,
...
enum class AttachmentDescriptionMaskBit : VkAttachmentDescriptionFlags { E_MAY_ALIAS_BIT = VK_ATTACHMENT_DESCRIPTION_MAY_ALIAS_BIT };

enum class SampleCountMaskBit : VkSampleCountFlags {
...
enum class CommandPoolResetMaskBit : VkCommandPoolResetFlags { E_RELEASE_RESOURCES_BIT = VK_COMMAND_POOL_RESET_RELEASE_RESOURCES_BIT };

enum class CommandBufferLevel { E_PRIMARY = VK_COMMAND_BUFFER_LEVEL_PRIMARY, E_SECONDARY = VK_COMMAND_BUFFER_LEVEL_SECONDARY };
...
enum class AccessMaskBit : VkAccessFlags {
...
enum class DeviceGroupPresentModeMaskBit : VkDeviceGroupPresentModeFlagsKHR {
...
enum class SparseImageFormatMaskBit : VkSparseImageFormatFlags {
...
enum class PresentScalingMaskBit : VkPresentScalingFlagsEXT {
...
enum class IndirectStateMaskBit : VkIndirectStateFlagsNV { E_FLAG_FRONTFACE_BIT_NV = VK_INDIRECT_STATE_FLAG_FRONTFACE_BIT_NV };

enum class MemoryMapMaskBit : VkMemoryMapFlags { E_PLACED_BIT_EXT = VK_MEMORY_MAP_PLACED_BIT_EXT };

enum class QueryPipelineStatisticMaskBit : VkQueryPipelineStatisticFlags {
...
enum class PipelineStageMaskBit : VkPipelineStageFlags {
...
enum class ExternalSemaphoreFeatureMaskBit : VkExternalSemaphoreFeatureFlags {
...
enum class ImageCreateMaskBit : VkImageCreateFlags {
...
enum class CommandBufferUsageMaskBit : VkCommandBufferUsageFlags {
...
enum class InternalAllocationType { E_EXECUTABLE = VK_INTERNAL_ALLOCATION_TYPE_EXECUTABLE };
...
enum class ShaderCorePropertiesMaskBit : VkShaderCorePropertiesFlagsAMD {};

enum class EventCreateMaskBit : VkEventCreateFlags { E_DEVICE_ONLY_BIT = VK_EVENT_CREATE_DEVICE_ONLY_BIT };
...
enum class GraphicsPipelineLibraryMaskBit : VkGraphicsPipelineLibraryFlagsEXT {
...
enum class ToolPurposeMaskBit : VkToolPurposeFlags {
...
enum class ConditionalRenderingMaskBit : VkConditionalRenderingFlagsEXT { E_INVERTED_BIT_EXT = VK_CONDITIONAL_RENDERING_INVERTED_BIT_EXT };

enum class SamplerYcbcrRange { E_ITU_FULL = VK_SAMPLER_YCBCR_RANGE_ITU_FULL, E_ITU_NARROW = VK_SAMPLER_YCBCR_RANGE_ITU_NARROW };

enum class Filter { E_NEAREST = VK_FILTER_NEAREST, E_LINEAR = VK_FILTER_LINEAR, E_CUBIC_EXT = VK_FILTER_CUBIC_EXT };

enum class CommandPoolCreateMaskBit : VkCommandPoolCreateFlags {
...
enum class PipelineCreateMaskBit2 : VkPipelineCreateFlags2KHR {
...
enum class VideoChromaSubsamplingMaskBit : VkVideoChromaSubsamplingFlagsKHR {
...
enum class FenceImportMaskBit : VkFenceImportFlags { E_TEMPORARY_BIT = VK_FENCE_IMPORT_TEMPORARY_BIT };

enum class DeviceAddressBindingMaskBit : VkDeviceAddressBindingFlagsEXT {
...
enum class BufferUsageMaskBit2 : VkBufferUsageFlags2KHR {
...
enum class BufferUsageMaskBit : VkBufferUsageFlags {
...
enum class SamplerMipmapMode { E_NEAREST = VK_SAMPLER_MIPMAP_MODE_NEAREST, E_LINEAR = VK_SAMPLER_MIPMAP_MODE_LINEAR };
...
enum class MicromapCreateMaskBit : VkMicromapCreateFlagsEXT {
...
enum class DebugReportMaskBit : VkDebugReportFlagsEXT {
...
enum class QueryControlMaskBit : VkQueryControlFlags { E_PRECISE_BIT = VK_QUERY_CONTROL_PRECISE_BIT };
...
enum class PipelineStageMaskBit2 : VkPipelineStageFlags2 {
...
enum class SubpassDescriptionMaskBit : VkSubpassDescriptionFlags {
  E_ENABLE_LEGACY_DITHERING_BIT_EXT = VK_SUBPASS_DESCRIPTION_ENABLE_LEGACY_DITHERING_BIT_EXT,
  ...
  E_RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_EXT = VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_COLOR_ACCESS_BIT_EXT,
  E_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT = VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT,
  E_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_EXT = VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_EXT
};
...
enum class FormatFeatureMaskBit : VkFormatFeatureFlags {
...
enum class OpticalFlowExecuteMaskBit : VkOpticalFlowExecuteFlagsNV {
  E_DISABLE_TEMPORAL_HINTS_BIT_NV = VK_OPTICAL_FLOW_EXECUTE_DISABLE_TEMPORAL_HINTS_BIT_NV
};

enum class QueryResultMaskBit : VkQueryResultFlags {
...
enum class CommandBufferResetMaskBit : VkCommandBufferResetFlags {
...
enum class SharingMode { E_EXCLUSIVE = VK_SHARING_MODE_EXCLUSIVE, E_CONCURRENT = VK_SHARING_MODE_CONCURRENT };
...
enum class ImageUsageMaskBit : VkImageUsageFlags {
...
enum class MemoryHeapMaskBit : VkMemoryHeapFlags {
...
enum class SamplerCreateMaskBit : VkSamplerCreateFlags {
  E_IMAGE_PROCESSING_BIT_QCOM = VK_SAMPLER_CREATE_IMAGE_PROCESSING_BIT_QCOM,
  E_NON_SEAMLESS_CUBE_MAP_BIT_EXT = VK_SAMPLER_CREATE_NON_SEAMLESS_CUBE_MAP_BIT_EXT,
  ...
  E_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT = VK_SAMPLER_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT
};

enum class PipelineCacheHeaderVersion { E_ONE = VK_PIPELINE_CACHE_HEADER_VERSION_ONE };

enum class FormatFeatureMaskBit2 : VkFormatFeatureFlags2 {
...
enum class OutOfBandQueueType { E_RENDER_NV = VK_OUT_OF_BAND_QUEUE_TYPE_RENDER_NV, E_PRESENT_NV = VK_OUT_OF_BAND_QUEUE_TYPE_PRESENT_NV };

enum class CullModeMaskBit : VkCullModeFlags {
...
enum class FrontFace { E_COUNTER_CLOCKWISE = VK_FRONT_FACE_COUNTER_CLOCKWISE, E_CLOCKWISE = VK_FRONT_FACE_CLOCKWISE };

enum class RenderPassCreateMaskBit : VkRenderPassCreateFlags { E_TRANSFORM_BIT_QCOM = VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM };

enum class DeviceQueueCreateMaskBit : VkDeviceQueueCreateFlags { E_PROTECTED_BIT = VK_DEVICE_QUEUE_CREATE_PROTECTED_BIT };

enum class VideoDecodeUsageMaskBit : VkVideoDecodeUsageFlagsKHR {
...
enum class VideoEncodeCapabilityMaskBit : VkVideoEncodeCapabilityFlagsKHR {
...
enum class ShaderCreateMaskBit : VkShaderCreateFlagsEXT {
...
enum class OpticalFlowSessionCreateMaskBit : VkOpticalFlowSessionCreateFlagsNV {
...
enum class MemoryPropertyMaskBit : VkMemoryPropertyFlags {
...
enum class VideoEncodeH265CtbSizeMaskBit : VkVideoEncodeH265CtbSizeFlagsKHR {
...
enum class SemaphoreWaitMaskBit : VkSemaphoreWaitFlags { E_ANY_BIT = VK_SEMAPHORE_WAIT_ANY_BIT };

enum class BufferCreateMaskBit : VkBufferCreateFlags {
...
enum class PipelineShaderStageCreateMaskBit : VkPipelineShaderStageCreateFlags {
...
enum class ExternalSemaphoreHandleTypeMaskBit : VkExternalSemaphoreHandleTypeFlags {
...
enum class ShaderStageMaskBit : VkShaderStageFlags {
...
enum class ImageViewCreateMaskBit : VkImageViewCreateFlags {
  ...
  E_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT = VK_IMAGE_VIEW_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT
};
...
enum class FenceCreateMaskBit : VkFenceCreateFlags { E_SIGNALED_BIT = VK_FENCE_CREATE_SIGNALED_BIT };
...
enum class ValidationCacheHeaderVersion { E_ONE_EXT = VK_VALIDATION_CACHE_HEADER_VERSION_ONE_EXT };
...
enum class HostImageCopyMaskBit : VkHostImageCopyFlagsEXT { E_MEMCPY_EXT = VK_HOST_IMAGE_COPY_MEMCPY_EXT };

enum class DebugUtilsMessageSeverityMaskBit : VkDebugUtilsMessageSeverityFlagsEXT {
...
enum class DescriptorBindingMaskBit : VkDescriptorBindingFlags {
...
enum class ResolveModeMaskBit : VkResolveModeFlags {
...
enum class PipelineCreateMaskBit : VkPipelineCreateFlags {
...
enum class VideoDecodeCapabilityMaskBit : VkVideoDecodeCapabilityFlagsKHR {
...
enum class VideoCodingControlMaskBit : VkVideoCodingControlFlagsKHR {
...
enum class GeometryMaskBit : VkGeometryFlagsKHR {
...
enum class BuildAccelerationStructureMaskBit : VkBuildAccelerationStructureFlagsKHR {
...
enum class AccelerationStructureCreateMaskBit : VkAccelerationStructureCreateFlagsKHR {
...
enum class VideoEncodeH265CapabilityMaskBit : VkVideoEncodeH265CapabilityFlagsKHR {
...
enum class VideoEncodeMaskBit : VkVideoEncodeFlagsKHR {};

enum class GeometryInstanceMaskBit : VkGeometryInstanceFlagsKHR {
...
enum class PipelineCacheCreateMaskBit : VkPipelineCacheCreateFlags {
...
enum class FramebufferCreateMaskBit : VkFramebufferCreateFlags { E_IMAGELESS_BIT = VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT };

enum class DisplayEventType { E_FIRST_PIXEL_OUT_EXT = VK_DISPLAY_EVENT_TYPE_FIRST_PIXEL_OUT_EXT };

enum class PipelineColorBlendStateCreateMaskBit : VkPipelineColorBlendStateCreateFlags {
  E_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_BIT_EXT = VK_PIPELINE_COLOR_BLEND_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_BIT_EXT
};
...
enum class MemoryDecompressionMethodMaskBit : VkMemoryDecompressionMethodFlagsNV {
...
enum class IndirectCommandsLayoutUsageMaskBit : VkIndirectCommandsLayoutUsageFlagsNV {
...
enum class StencilFaceMaskBit : VkStencilFaceFlags {
...
enum class PerformanceCounterDescriptionMaskBit : VkPerformanceCounterDescriptionFlagsKHR {
...
enum class AcquireProfilingLockMaskBit : VkAcquireProfilingLockFlagsKHR {};
...
enum class QueryPoolSamplingMode { E_MANUAL_INTEL = VK_QUERY_POOL_SAMPLING_MODE_MANUAL_INTEL };
...
enum class VideoEncodeContentMaskBit : VkVideoEncodeContentFlagsKHR {
...
enum class VideoEncodeH264RateControlMaskBit : VkVideoEncodeH264RateControlFlagsKHR {
...
enum class PipelineCreationFeedbackMaskBit : VkPipelineCreationFeedbackFlags {
...
enum class ImageCompressionMaskBit : VkImageCompressionFlagsEXT {
...
enum class AccessMaskBit2 : VkAccessFlags2 {
...
enum class PipelineLayoutCreateMaskBit : VkPipelineLayoutCreateFlags {
  E_INDEPENDENT_SETS_BIT_EXT = VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT
};
...
enum class PresentGravityMaskBit : VkPresentGravityFlagsEXT {
...
enum class VideoDecodeH264PictureLayoutMaskBit : VkVideoDecodeH264PictureLayoutFlagsKHR {
...
enum class PipelineDepthStencilStateCreateMaskBit : VkPipelineDepthStencilStateCreateFlags {
  E_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT =
    VK_PIPELINE_DEPTH_STENCIL_STATE_CREATE_RASTERIZATION_ORDER_ATTACHMENT_DEPTH_ACCESS_BIT_EXT,
  E_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_EXT =
...
enum class FrameBoundaryMaskBit : VkFrameBoundaryFlagsEXT { E_FRAME_END_BIT_EXT = VK_FRAME_BOUNDARY_FRAME_END_BIT_EXT };

enum class VideoComponentBitDepthMaskBit : VkVideoComponentBitDepthFlagsKHR {
...
enum class OpticalFlowUsageMaskBit : VkOpticalFlowUsageFlagsNV {
...
enum class PhysicalDeviceSchedulingControlsMaskBit : VkPhysicalDeviceSchedulingControlsFlagsARM {
...
enum class VideoCodecOperationMaskBit : VkVideoCodecOperationFlagsKHR {
...
enum class SemaphoreImportMaskBit : VkSemaphoreImportFlags { E_TEMPORARY_BIT = VK_SEMAPHORE_IMPORT_TEMPORARY_BIT };

enum class VideoCapabilityMaskBit : VkVideoCapabilityFlagsKHR {
...
enum class ImageAspectMaskBit : VkImageAspectFlags {
...
enum class SubmitMaskBit : VkSubmitFlags { E_PROTECTED_BIT = VK_SUBMIT_PROTECTED_BIT, E_PROTECTED_BIT_KHR = VK_SUBMIT_PROTECTED_BIT_KHR };

enum class VideoSessionCreateMaskBit : VkVideoSessionCreateFlagsKHR {
...
enum class VideoEncodeUsageMaskBit : VkVideoEncodeUsageFlagsKHR {
...
enum class VideoEncodeFeedbackMaskBit : VkVideoEncodeFeedbackFlagsKHR {
...
enum class VideoEncodeH264CapabilityMaskBit : VkVideoEncodeH264CapabilityFlagsKHR {
...
enum class VideoEncodeH264StdMaskBit : VkVideoEncodeH264StdFlagsKHR {
...
enum class SurfaceCounterMaskBit : VkSurfaceCounterFlagsEXT { E_VBLANK_BIT_EXT = VK_SURFACE_COUNTER_VBLANK_BIT_EXT };

enum class RenderingMaskBit : VkRenderingFlags {
...
enum class VideoEncodeH265RateControlMaskBit : VkVideoEncodeH265RateControlFlagsKHR {
...
enum class SurfaceTransformMaskBit : VkSurfaceTransformFlagsKHR {
...
enum class PipelineCompilerControlMaskBit : VkPipelineCompilerControlFlagsAMD {};

enum class VideoEncodeH265TransformBlockSizeMaskBit : VkVideoEncodeH265TransformBlockSizeFlagsKHR {
...
enum class SemaphoreCreateMaskBit : VkSemaphoreCreateFlags {};

enum class BuildMicromapMode { E_BUILD_EXT = VK_BUILD_MICROMAP_MODE_BUILD_EXT };

enum class InstanceCreateMaskBit : VkInstanceCreateFlags {
  E_ENUMERATE_PORTABILITY_BIT_KHR = VK_INSTANCE_CREATE_ENUMERATE_PORTABILITY_BIT_KHR
};

enum class QueueMaskBit : VkQueueFlags {
...
enum class ImageCompressionFixedRateMaskBit : VkImageCompressionFixedRateFlagsEXT {
...
enum class BuildMicromapMaskBit : VkBuildMicromapFlagsEXT {
...
enum class DeviceFaultVendorBinaryHeaderVersion { E_ONE_EXT = VK_DEVICE_FAULT_VENDOR_BINARY_HEADER_VERSION_ONE_EXT };
...
enum class ShaderCodeType { E_BINARY_EXT = VK_SHADER_CODE_TYPE_BINARY_EXT, E_SPIRV_EXT = VK_SHADER_CODE_TYPE_SPIRV_EXT };
...
enum class VertexInputRate { E_VERTEX = VK_VERTEX_INPUT_RATE_VERTEX, E_INSTANCE = VK_VERTEX_INPUT_RATE_INSTANCE };
